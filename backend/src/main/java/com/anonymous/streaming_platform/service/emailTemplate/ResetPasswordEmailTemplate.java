...
public class ResetPasswordEmailTemplate extends EmailTemplate {

    @Override
    public void buildBody(Object... args) { // username, token
        try {
            this.body = """
                <html>
            ...
            throw new InternalServerException(Error.MESSAGE_FORMAT_EXCEPTION, "ResetPasswordEmailTemplate");
        }
    }
}
